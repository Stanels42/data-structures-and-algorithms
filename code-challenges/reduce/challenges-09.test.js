...
const countNumberOfChildren = (arr) => {
  return arr.reduce((totalChildren, person)=> person.children ? totalChildren + person.children.length : totalChildren ,0);
};
...
const extractStat = (statName, arr) => {
  return arr.reduce((tracker, current)=> current.stat.name === current ? current : tracker );
};
